...
describe("[Challenge] Side entrance", function () {
    ...
    it("Exploit", async function () {
        ...
        const hackContract = await ethers.getContractFactory("HackSideEntrance", deployer);
        this.hack = await hackContract.deploy(this.pool.address);
        await this.hack.connect(attacker).attack();
    });
